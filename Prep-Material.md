...
1.An e-commerce company wants to build an AI assistant that answers product-related questions using its internal product catalog and policy documents stored in Amazon S3. They want the assistant's answers to be grounded in actual company content, not just general knowledge.
